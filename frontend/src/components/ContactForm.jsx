    ...
    <div className="bg-black py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
          <div className="flex flex-col justify-center items-center md:items-center md:pr-4">
            <div className="w-full md:max-w-md">
              <h2 className="text-4xl font-bold text-white mb-8 text-center md:text-left">Have questions?<br/> We are here to help</h2>
              <div className="space-y-8 hidden md:block">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="mailto:devplexai@yahoo.com" className="text-white text-lg hover:text-indigo-400 transition-colors">
                      devplexai@yahoo.com
                    </a>
                  </div>
                </div>

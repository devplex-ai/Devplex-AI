    ...
    return (
      <>
        <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white flex flex-col items-center justify-center px-4 py-6 md:py-16">
          ...
          <p className="text-sm md:text-lg text-gray-300 text-center max-w-2xl mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 px-4 gap-4 md:gap-12 max-w-6xl">
            <div className="flex flex-col items-center text-center bg-[#12141F] p-6 md:p-10 rounded-xl border border-white/10">

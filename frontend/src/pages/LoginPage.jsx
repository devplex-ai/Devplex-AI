...
const LoginPage = ({ onClose = () => {} }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div
        onClick={onClose}
        className="fixed inset-0 bg-gray-950 opacity-80 blur-2xl" // Removed blur and opacity for debugging
      ></div>
      ...
      <div className="w-full max-w-md bg-gray-900 p-8 rounded-2xl shadow-2xl border border-gray-700 z-20">
        ...
        <div className="flex gap-3 mb-6">
          ...
          <button
            ...
            className="flex-1 gap-1 bg-black border border-gray-800 hover:bg-gray-900 text-white font-medium py-3 px-4 rounded-xl flex items-center justify-center transition-all duration-200 shadow-sm hover:shadow disabled:opacity-70"
          >
